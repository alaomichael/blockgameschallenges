...
module.exports = {
  ...
  networks: {
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/e3b567b6ce734c4caa2d491b7344fa38", // <---- YOUR INFURA ID! (or it won't work)
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/e3b567b6ce734c4caa2d491b7344fa38", // <---- YOUR INFURA ID! (or it won't work)
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/e3b567b6ce734c4caa2d491b7344fa38", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      url: "https://goerli.infura.io/v3/e3b567b6ce734c4caa2d491b7344fa38", // <---- YOUR INFURA ID! (or it won't work)
